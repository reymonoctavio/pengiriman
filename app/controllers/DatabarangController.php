...
class DatabarangController extends SecureController{
	...
	function index(){
		...
		$db = $this->GetModel();
		$pagination = null;
		$sqltext = "SELECT SQL_CALC_FOUND_ROWS   p.nama, b.berat, b.nama_brg FROM barang AS b join pengirim AS p on p.id_pengirim=b.id_pengirim";
		$queryparams = null;
		...
		$page_title = $this->view->page_title = "Databarang";
