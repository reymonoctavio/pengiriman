...
class BarangController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array("barang.id_barang", 
			...
			"barang.id_penerima", 
			"penerima.penerima AS penerima_penerima", 
			"barang.id_layanan", 
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				barang.id_pengirim LIKE ? OR 
				barang.id_penerima LIKE ? OR 
				barang.id_layanan LIKE ? OR 
				barang.tgl_masuk LIKE ? OR 
				barang.nama_brg LIKE ? OR 
				barang.berat LIKE ? OR 
				barang.biaya LIKE ? OR 
				biaya * berat LIKE ?
			)";
			$search_params = array(
		...
		$db->join("pengirim", "barang.id_pengirim = pengirim.id_pengirim", "INNER");
		$db->join("penerima", "barang.id_penerima = penerima.id_penerima", "INNER");
		$db->join("layanan", "barang.id_layanan = layanan.id_layanan", "INNER");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_brg","tgl_masuk","id_pengirim","id_penerima","id_layanan","biaya","berat");
			...
			$this->sanitize_array = array(
				'nama_brg' => 'sanitize_string',
				'tgl_masuk' => 'sanitize_string',
				'id_pengirim' => 'sanitize_string',
				'id_penerima' => 'sanitize_string',
				'id_layanan' => 'sanitize_string',
				'biaya' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_barang","nama_brg","tgl_masuk","id_pengirim","id_penerima","id_layanan","biaya","berat");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_brg' => 'required',
