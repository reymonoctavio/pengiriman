...
define("SITE_NAME", "class_kurir_1 v1");
...
define("APP_ID", "9e6b37ddc3f75764431fa8b921ea9c37");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['nama'] : null ));
